...
function ChangeBlogStatusPopup({
	...
	return (
		<div
			style={{ display: showChangeBlogStatusPopup ? 'flex' : 'none' }}
			className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-lg shadow-lg  flex flex-col justify-between gap-10 z-[999]'>
			...
			<div className='flex justify-center mt-4'>
				...
				<button
					disabled={loading}
					onClick={() => setShowChangeBlogStatusPopup(false)}
					className={`px-4 py-2 ${
