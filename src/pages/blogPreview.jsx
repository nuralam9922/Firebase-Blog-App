...
import { Button, Navbar, ProgressBar } from '../components';
	...
	return (
		<>
			...
			<section
				...
				} flex items-center justify-center text-justify my-10 md:px-5 gap-32 `}>
			...
			<div className='w-full my-5  pb-10'>
				<Button
					label='Next'
					className={'float-end bg-blue-200 text-black'}
			...
			<section
				className={`absolute ${
					isPopupOpen ? 'block' : 'hidden'
				} top-0 left-0 z-[99] bg-background  w-full min-h-screen`}>
				<Button
					label='Close ❌'
					className={'float-end bg-blue-200 text-black mt-10'}
					onClick={() => setIsPopupOpen((prev) => !prev)}
				/>
