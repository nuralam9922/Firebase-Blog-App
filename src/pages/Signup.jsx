	...
	return (
		<div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
			<div className="sm:mx-auto sm:w-full sm:max-w-md">
				<h2 className="mt-6 text-center text-3xl font-[500] text-gray-900">Create an account</h2>
			</div>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div>
							{loading ? (
								...
								<SecondaryButton label={'Sign up'} className={'w-full'} type={'submit'} />
							)}
						</div>
					</form>
					<p className="mt-5">
						Already have an account? <Link to={'/auth/login'}>Login up</Link>
					</p>
				</div>
			</div>
		</div>
